export default function AddPurchasedCard({ books }) {
    return (
        <>
            {books?.map((book) => (
                <div className="card inline-flex flex-col justify-around p-5 rounded-[48px] bg-white/5" key={book.id}>
                    ...
                    <div className="card-body w-full mt-2">
                        ...
                        <div className="flex items-stretch mt-4">
                            ...
                            <button href="" className="inline-flex justify-center items-center px-3 bg-indigo-500 hover:bg-indigo-600 cursor-pointer ml-3 rounded-full">
