export default function SearchBooks({ placeholder }) {
    return (
        <div className="flex max-w-5xl mx-auto relative">
            ...
            <input type="search" name="search" id="search" className="bg-white/5 py-5 pl-14 pr-8 outline-none w-full rounded-full placeholder:text-white caret-white" placeholder={placeholder ? placeholder : 'Search your favorite book here...'} />
        </div>
    );
}
